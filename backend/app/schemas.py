...
class PositionPrize(BaseModel):
    position:int=Field(ge=1,le=3); title:str=Field(min_length=2,max_length=120); prize_type:str="CASH"; amount:float|None=Field(default=None,gt=0)
class LotteryCreate(BaseModel):
    name:str; slug:str; description:str; entry_price:float=Field(gt=0); start_at:datetime; join_deadline:datetime; result_at:datetime; max_tickets:int=Field(gt=0); min_tickets:int=1; status:str="DRAFT"; terms:str=""; banner_url:str|None=None; prizes:list[PositionPrize]=Field(default_factory=list)
...
class WithdrawalCreate(BaseModel): amount:float=Field(gt=0)
...
class LotteryUpdate(BaseModel):
    name:str|None=None; description:str|None=None; entry_price:float|None=Field(default=None,gt=0); start_at:datetime|None=None; join_deadline:datetime|None=None; result_at:datetime|None=None; max_tickets:int|None=Field(default=None,gt=0); min_tickets:int|None=None; status:str|None=None; terms:str|None=None; banner_url:str|None=None; prizes:list[PositionPrize]|None=None
